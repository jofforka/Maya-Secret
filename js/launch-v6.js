...
window.MayaLaunch=Object.freeze({version:'6.0.0',rewards,find(code){return rewards[clean(code)]||null;},clean});
...
const badge=document.createElement('span');badge.className='launch-edition-badge';badge.textContent='v6.0 Launch Edition';document.body.appendChild(badge);
})();
